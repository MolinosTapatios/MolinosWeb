...
function Menu(params) {
    ...
    // const icon2 = <span className='navbar-toggler-icon'></span>;
            ...
            <Navbar bg="light" expand="sm">
                <Container fluid>
                    ...
                    <Form className="d-flex col" >
                        ...
                        {/* <label htmlFor="" className='botonLines btn btn-outline-warning'><span className='navbar-toggler-icon'></span></label> */}
